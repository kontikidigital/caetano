 ...
 * Caetano.
 *
 * This file adds the default theme settings to the Caetano Theme.
 *
 * @package Caetano
 * @author  Max Terbeck
...
add_filter( 'genesis_theme_settings_defaults', 'caetano_theme_defaults' );
/**
 ...
 */
function caetano_theme_defaults( $defaults ) {
...
add_filter( 'simple_social_default_styles', 'caetano_social_default_styles' );
/**
 ...
 */
function caetano_social_default_styles( $defaults ) {
