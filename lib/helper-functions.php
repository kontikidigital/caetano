 ...
 * Caetano.
 *
 * This file adds the required helper functions used in the Caetano Theme.
 *
 * @package Caetano
 * @author  Max Terbeck
 ...
 */
function caetano_customizer_get_default_link_color() {
 ...
 */
function caetano_customizer_get_default_accent_color() {
 ...
 */
function caetano_color_contrast( $color ) {
 ...
 */
function caetano_color_brightness( $color, $change ) {
